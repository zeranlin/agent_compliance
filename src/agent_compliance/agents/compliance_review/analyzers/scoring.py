...
from agent_compliance.core.pipelines.tender_document_parser import clause_in_structured_sections
from agent_compliance.core.pipelines.tender_document_risk_scope_layer import RISK_SCOPE_CORE, RISK_SCOPE_SUPPORTING, STRUCTURE_SCORING_RULES
from agent_compliance.core.schemas import Finding, NormalizedDocument, StructuredTenderDocument
