...
from agent_compliance.core.knowledge.procurement_catalog import CatalogClassification, classify_procurement_catalog
...
from agent_compliance.core.schemas import NormalizedDocument, RuleHit
