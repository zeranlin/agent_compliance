...
from agent_compliance.core.pipelines.tender_document_risk_scope_layer import RISK_SCOPE_CORE
from agent_compliance.core.pipelines.requirement_scope_layer import (
    EFFECT_STRONG_BINDING,
    classify_requirement_scope,
)
from agent_compliance.agents.compliance_review.pipelines.review_arbiter import line_ranges_overlap
