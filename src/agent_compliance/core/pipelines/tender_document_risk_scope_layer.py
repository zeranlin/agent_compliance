...
from agent_compliance.core.schemas import Clause, NormalizedDocument
...
ATTACHMENT_MARKERS = ("投标函", "承诺函", "声明函", "授权委托书", "法定代表人证明书", "附件", "样表", "我单位承诺如下")
ATTACHMENT_TEMPLATE_MARKERS = ("政府采购投标及履约承诺函", "中小企业声明函", "残疾人福利性单位声明函", "监狱企业声明函", "我单位承诺如下")
