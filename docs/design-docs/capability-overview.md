...
本项目当前不是单次问答式审稿助手，而是一个面向政府采购人“采购需求形成与发布前审查”阶段的可持续进化型智能体工作框架。
...
因此，本项目当前已经不是“帮你看一段采购需求有没有问题”的单点能力，而是一套面向政府采购需求发布前风险预审的可持续、可复核、可复用的审查体系。

它当前第一目标不是做争议裁判，而是帮助采购人在发布前：
- 发现风险
- 完成改稿
- 做好复核
- 更放心地把采购需求进行公布
