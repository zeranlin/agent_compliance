...
- `qualification_bundle_analyzer` 已进一步细化，可把一般门槛和行业错位资质拆成更精准的资格子主题，并已在 BK 电子仪器仪表采购项目样本中验证出：
...
- `commercial_burden_analyzer` 已进一步细化，可把资金占用、验收费转嫁和责任失衡分层收束为商务主问题，并已在 BK 电子仪器仪表采购项目样本中验证出：
  - 商务条款设置异常资金占用和交货期限
