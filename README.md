...
本仓库定义了一套面向政府采购人“采购需求形成与发布前审查”阶段的 harness 化架构。

目标不只是回答“某条款有没有风险”，而是帮助采购人在正式发布采购需求、招标文件或磋商文件前，尽早发现可能影响公平竞争、履约边界、验收可执行性和合同平衡性的风险，并把智能体的工作回路做成可检查、可续跑、可评测、可持续改进的系统。
